...
internal class BooksOrderTest {
    ...
    fun whenNoBooksArePurchasedAnEmptyInvoiceShouldBeCreatedOnCheckout() {
        ...
        val actualInvoice = clientOrder.checkOut()

        // the ID is automatically generated by the system
        // we will use the generated one to created our expected
        val invoiceId = actualInvoice.id

        val expectedInvoice = Invoice("Client A", usa, invoiceId)
