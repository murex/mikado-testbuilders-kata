...
import com.murex.tbw.domain.builders.AuthorTestDataBuilder;
import com.murex.tbw.domain.builders.NovelTestDataBuilder;
import com.murex.tbw.domain.country.Country;
import com.murex.tbw.purchase.builders.InvoiceTestDataBuilder;
import org.junit.jupiter.api.Test;

import java.util.List;

import static com.murex.tbw.domain.builders.CountryTestDataBuilder.aCountry;
...
import static com.murex.tbw.purchase.builders.PurchasedBookTestDataBuilder.aPurchasedBook;
...
class InvoiceTest {
    ...
    void No_Constraint_Applies_tax_rules_when_computing_total_amount() {
        ...
        Country unitedKingdom = new Country("UK", POUND_STERLING, ENGLISH);
    ...
    void Test_Data_Builders_Constraint_Applies_tax_rules_when_computing_total_amount() {
        Author author = AuthorTestDataBuilder
                .anAuthor()
                .withName("George Orwell")
                .from(aCountry()
                        .withName("UK")
                        .withCurrency(POUND_STERLING)
