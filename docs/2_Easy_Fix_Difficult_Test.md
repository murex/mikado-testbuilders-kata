...
You can refer to the below UML diagram to have an understanding of the 
relationship between the classes of this project: 

![Mikado game sticks](images/UML_Diagram.jpg)
